...
export default function DetectiveLanding() {
  ...
  // Tack positions (relative to board, in percentages)
  const tacks = [
    { id: 'notes', x: 67, y: 14 },        // Field Notes
    { id: 'education', x: 54, y: 8 },     // Education
    { id: 'tools', x: 15, y: 28 },        // Tools
    { id: 'interests', x: 82, y: 32 },    // Interests
    { id: 'aerospace', x: 18, y: 56 },    // Aerospace
    { id: 'contact', x: 85, y: 60 },      // Contact
    { id: 'evidence', x: 34, y: 70 },     // Evidence
    { id: 'status', x: 65, y: 88 }        // Status
  ]

  // String connections - creating an investigation web
  const connections = [
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg style={{
              ...
              <text x="55%" y="14%" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold" fontFamily="Special Elite">Garching</text>
              
              {/* TUM Central Munich (center) */}
              <circle cx="48%" cy="52%" r="6" className="location-marker"/>
              <text x="48%" y="48%" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold" fontFamily="Special Elite">TUM</text>
              
              {/* TUM Ottobrunn (southeast) */}
              <circle cx="65%" cy="72%" r="6" className="location-marker"/>
              <text x="65%" y="68%" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold" fontFamily="Special Elite">Ottobrunn</text>
              
              {/* Haar (east) */}
              <circle cx="72%" cy="55%" r="6" className="location-marker"/>
              <text x="72%" y="51%" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold" fontFamily="Special Elite">Haar</text>
            </svg>
          </div>
        </div>
